...
compose_schemas: List[ComposeSchema] = [
    ...
    ComposeSchema(
        ...
        desc="Similar to text_slide, with an image on the right. Use it time to time to introduce variety.",
        func=create_image_slide_builder(aspect_ratio="2:3"),
        slide_layout_index=3,
    ),
    ComposeSchema(
        name="image_left_slide",
        desc="Similar to text_slide, with an image on the left. Use it time to time to introduce variety.",
